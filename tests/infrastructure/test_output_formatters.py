...
from ai_context_cli.domain.models import ContentMeta, ContentStructure, ProcessedContent, Section
...
def _processed_content() -> ProcessedContent:
    return ProcessedContent(
        ...
        structure=ContentStructure(
            title="Example title",
            sections=[Section(heading="Example title", level=1, subsections=[])],
            entities=[],
        ),
        meta=ContentMeta(
            word_count=4,
